...
class Logger(object):
    ...
    def __init__(self, log_dir, logging_level='INFO', console_logger=False) -> None:
        super().__init__()
    ...
    def _make_level(self):
        if self.logging_level == 'info':
            ...
            raise ValueError('logging_level not specified correctly. INFO, WARNING or ERROR must be choosed')
